-- CreateEnum
CREATE TYPE "OauthProviderType" AS ENUM ('GOOGLE');
...
-- CreateEnum
CREATE TYPE "VerdictType" AS ENUM ('TRUE', 'MOSTLY_TRUE', 'MIXED', 'MOSTLY_FALSE', 'FALSE', 'UNKNOWN');
...
-- AddForeignKey
ALTER TABLE "Claim" ADD CONSTRAINT "Claim_factCheckSessionId_fkey" FOREIGN KEY ("factCheckSessionId") REFERENCES "FactCheckSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ClaimVerification" ADD CONSTRAINT "ClaimVerification_factCheckSessionId_fkey" FOREIGN KEY ("factCheckSessionId") REFERENCES "FactCheckSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
